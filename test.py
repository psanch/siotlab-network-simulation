...
Score.verbose = True # Plot will block on input, any key will continue. Not good for batch tests.
...
Score.approaches_ordered = Score.approaches.keys() # Don't touch; used for consistent key ordering
